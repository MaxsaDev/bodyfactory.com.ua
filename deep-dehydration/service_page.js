...
// Элементы для секции "Зони масажу"
...
async function getDATA() {
  const data = await fetch("../deep-dehydration/data.json");
  return data.json();
}
