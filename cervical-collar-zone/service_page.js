...
// Елементи для секції "Зони масажу"
...
async function getDATA() {
  const data = await fetch("../cervical-collar-zone/data.json");
  return data.json();
}
...
if (res.body_zones) {
  ...
  // Якщо дані про зони масажу відсутні, приховуємо секцію
  document.querySelector(".body_zones_section").style.display = "none";
}
