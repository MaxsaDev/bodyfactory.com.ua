...
async function getDATA() {
  const data = await fetch("../anticellulite/data.json");
  return data.json();
}
...
<!--<td colspan="4" class="service_price_table_row service_price-notes">Комбо пропозиція - це окремий продукт на який встановлена спеціальна ціна, тому акційні пропозиції на кшталт "гарячі години" або " парний масаж - 25%" на нього не діє. </td>-->
    <td colspan="4" class="service_price_table_row service_price-notes">
<!--        <span style="font-size: 12px; color: var(&#45;&#45;middle-third); line-height: 0.4rem">-->
